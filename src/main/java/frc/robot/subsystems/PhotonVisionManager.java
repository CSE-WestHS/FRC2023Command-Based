...
public class PhotonVisionManager {
    ...
    //
    // 8 targets on field, making them start at 1 because frc used 1-8 instead of
    // 0-7
    // This version is built for AprilTags.
    // to use: instantiate and call SetCamera with name of your camera.Then place
    // Update in Robot Periodic and call methods when needed!
    ...
    public int[] AprilTagsSeen() {
        ...
        // Dont ask me why I took this approach, it sucks but I REALLY wanted an int
        // array output.
    ...
    // Methods below throw NullPointerException, exception must be handled when
    // methods are called.
