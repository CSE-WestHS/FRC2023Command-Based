...
public class OI {
  ...
  //should be renamed to fit the purpose of the command it works with
  static Trigger aButton2 = new JoystickButton(DriveController, Constants.A_BUTTONPORT); // a button
  static Trigger bButton2 = new JoystickButton(DriveController, Constants.B_BUTTONPORT); // b button
  static Trigger xButton2 = new JoystickButton(DriveController, Constants.X_BUTTONPORT); // x button
  static Trigger yButton2 = new JoystickButton(DriveController, Constants.Y_BUTTONPORT); // y button
  static Trigger startButton2 = new JoystickButton(DriveController, Constants.START_BUTTONPORT); // start button
  static Trigger backButton2 = new JoystickButton(DriveController, Constants.BACK_BUTTONPORT); // back button - being used to cancel commands, can be changed.
  static Trigger LBButton2 = new JoystickButton(DriveController, Constants.LB_BUTTONPORT); // left bumper
  static Trigger RBButton2 = new JoystickButton(DriveController, Constants.RB_BUTTONPORT); // right bumper
  static Trigger downDPButton2 = new POVButton(DriveController, Constants.DP_DOWN_BUTTONPORT); // down on D-Pad
  static Trigger upDPButton2 = new POVButton(DriveController, Constants.DP_UP_BUTTONPORT); // up on D-Pad
  static Trigger leftDPButton2 = new POVButton(DriveController, Constants.DP_LEFT_BUTTONPORT); // left on D-Pad
  static Trigger rightDPButton2 = new POVButton(DriveController, Constants.DP_RIGHT_BUTTONPORT); // right on D-Pad
}